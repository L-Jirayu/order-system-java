...
public final class OrderServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<com.example.order.CreateOrderRequest,
      com.example.order.CreateOrderResponse> getCreateOrderMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "CreateOrder",
      requestType = com.example.order.CreateOrderRequest.class,
      responseType = com.example.order.CreateOrderResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.example.order.CreateOrderRequest,
      com.example.order.CreateOrderResponse> getCreateOrderMethod() {
    io.grpc.MethodDescriptor<com.example.order.CreateOrderRequest, com.example.order.CreateOrderResponse> getCreateOrderMethod;
      ...
      synchronized (OrderServiceGrpc.class) {
        if ((getCreateOrderMethod = OrderServiceGrpc.getCreateOrderMethod) == null) {
          OrderServiceGrpc.getCreateOrderMethod = getCreateOrderMethod =
              io.grpc.MethodDescriptor.<com.example.order.CreateOrderRequest, com.example.order.CreateOrderResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "CreateOrder"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.example.order.CreateOrderRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.example.order.CreateOrderResponse.getDefaultInstance()))
  ...
  private static volatile io.grpc.MethodDescriptor<com.example.order.GetOrderStatusRequest,
      com.example.order.GetOrderStatusResponse> getGetOrderStatusMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "GetOrderStatus",
      requestType = com.example.order.GetOrderStatusRequest.class,
      responseType = com.example.order.GetOrderStatusResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.example.order.GetOrderStatusRequest,
      com.example.order.GetOrderStatusResponse> getGetOrderStatusMethod() {
    io.grpc.MethodDescriptor<com.example.order.GetOrderStatusRequest, com.example.order.GetOrderStatusResponse> getGetOrderStatusMethod;
      ...
      synchronized (OrderServiceGrpc.class) {
        if ((getGetOrderStatusMethod = OrderServiceGrpc.getGetOrderStatusMethod) == null) {
          OrderServiceGrpc.getGetOrderStatusMethod = getGetOrderStatusMethod =
              io.grpc.MethodDescriptor.<com.example.order.GetOrderStatusRequest, com.example.order.GetOrderStatusResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "GetOrderStatus"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.example.order.GetOrderStatusRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.example.order.GetOrderStatusResponse.getDefaultInstance()))
  ...
  public interface AsyncService {
    ...
    /**
     */
    default void createOrder(com.example.order.CreateOrderRequest request,
        io.grpc.stub.StreamObserver<com.example.order.CreateOrderResponse> responseObserver) {
      io.grpc.stub.ServerCalls.asyncUnimplementedUnaryCall(getCreateOrderMethod(), responseObserver);
    }

    /**
     */
    default void getOrderStatus(com.example.order.GetOrderStatusRequest request,
        io.grpc.stub.StreamObserver<com.example.order.GetOrderStatusResponse> responseObserver) {
  ...
  public static final class OrderServiceStub
    ...
    /**
     */
    public void createOrder(com.example.order.CreateOrderRequest request,
        io.grpc.stub.StreamObserver<com.example.order.CreateOrderResponse> responseObserver) {
    ...
    /**
     */
    public void getOrderStatus(com.example.order.GetOrderStatusRequest request,
        io.grpc.stub.StreamObserver<com.example.order.GetOrderStatusResponse> responseObserver) {
      io.grpc.stub.ClientCalls.asyncUnaryCall(
  ...
  public static final class OrderServiceBlockingStub
    ...
    /**
     */
    public com.example.order.CreateOrderResponse createOrder(com.example.order.CreateOrderRequest request) {
    ...
    /**
     */
    public com.example.order.GetOrderStatusResponse getOrderStatus(com.example.order.GetOrderStatusRequest request) {
      return io.grpc.stub.ClientCalls.blockingUnaryCall(
  ...
  public static final class OrderServiceFutureStub
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<com.example.order.CreateOrderResponse> createOrder(
        com.example.order.CreateOrderRequest request) {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<com.example.order.GetOrderStatusResponse> getOrderStatus(
        com.example.order.GetOrderStatusRequest request) {
      return io.grpc.stub.ClientCalls.futureUnaryCall(
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_CREATE_ORDER:
          serviceImpl.createOrder((com.example.order.CreateOrderRequest) request,
              (io.grpc.stub.StreamObserver<com.example.order.CreateOrderResponse>) responseObserver);
          break;
        case METHODID_GET_ORDER_STATUS:
          serviceImpl.getOrderStatus((com.example.order.GetOrderStatusRequest) request,
              (io.grpc.stub.StreamObserver<com.example.order.GetOrderStatusResponse>) responseObserver);
          break;
        default:
    ...
    return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
        .addMethod(
          ...
          io.grpc.stub.ServerCalls.asyncUnaryCall(
            new MethodHandlers<
              com.example.order.CreateOrderRequest,
              com.example.order.CreateOrderResponse>(
                service, METHODID_CREATE_ORDER)))
        .addMethod(
          getGetOrderStatusMethod(),
          io.grpc.stub.ServerCalls.asyncUnaryCall(
            new MethodHandlers<
              com.example.order.GetOrderStatusRequest,
              com.example.order.GetOrderStatusResponse>(
